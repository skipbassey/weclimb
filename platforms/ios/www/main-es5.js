...
var AppointmentComponent = /** @class */ (function () {
    function AppointmentComponent(modalController, appointmentService, platformService) {
    ...
    AppointmentComponent.prototype.parseAppointments = function (res) {
        var appts = [];
...
var CalendarComponent = /** @class */ (function () {
    function CalendarComponent(modalController, apptService, toasterService, alertController, platformService, router) {
        this.modalController = modalController;
    ...
    CalendarComponent.prototype.removeAppointment = function (apt) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (blah) {
                                        _this.apptService.removeAppointment(apt);
                                        _this.appts = _this.apptService.schedule;
                                    }
                                }, {
                                    text: 'No',
                                    handler: function () {
...
var FeesComponent = /** @class */ (function () {
    function FeesComponent(platformService) {
        this.platformService = platformService;
        this.mode = "";
    }
    ...
    FeesComponent.ctorParameters = function () { return [
...
var ForgotPasswordComponent = /** @class */ (function () {
    function ForgotPasswordComponent(formBuilder, modalController, userService, toasterService, loadingService, platformService) {
...
var ForgotUsernameComponent = /** @class */ (function () {
    function ForgotUsernameComponent(formBuilder, userService, toastController, loadingController, modalController, platformService) {
        this.formBuilder = formBuilder;
        this.userService = userService;
...
var AdolescentModule = /** @class */ (function () {
    function AdolescentModule(platformService) {
        this.platformService = platformService;
        this.mode = "";
    }
    AdolescentModule.prototype.ngOnInit = function () {
        this.mode = this.platformService.getPlatform();
    };
    AdolescentModule.ctorParameters = function () { return [
...
var CareerComponent = /** @class */ (function () {
    function CareerComponent(platformService) {
        this.platformService = platformService;
        this.mode = "";
    }
...
var FamilyComponent = /** @class */ (function () {
    function FamilyComponent(platformService) {
        this.platformService = platformService;
        this.mode = "";
    }
...
module.exports = ".welcome-card img {\n  max-height: 35vh;\n  overflow: hidden;\n}\n\n.card {\n  height: 90%;\n}\n\n.primary {\n  background-color: black;\n}\n\n.services-container {\n  padding: 10px;\n  text-align: center;\n}\n\n.text {\n  text-align: center;\n  color: black;\n}\n\n.title {\n  text-align: center;\n  font-weight: bold;\n}\n\n.services-container {\n  margin-top: 15px;\n  margin-bottom: 0px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var IndividualComponent = /** @class */ (function () {
    function IndividualComponent(platformService) {
        this.platformService = platformService;
        this.mode = "";
    }
    ...
    IndividualComponent.ctorParameters = function () { return [
        { type: src_services_platform_service__WEBPACK_IMPORTED_MODULE_2__["PlatformService"] }
    ]; };
...
var RelationshipComponent = /** @class */ (function () {
    function RelationshipComponent(platformService) {
        this.platformService = platformService;
        this.mode = "";
    }
...
module.exports = "img {\n  width: 70%;\n}\n\n.logo-container {\n  margin: 30px;\n  padding: 15px;\n  text-align: center;\n}\n\n.button-container {\n  margin: 25px;\n  text-align: center;\n}\n\na {\n  margin: 10px;\n}\n\n.credential-container {\n  margin: 20px;\n}\n\n.action-btn-container {\n  display: -webkit-box;\n  display: flex;\n  text-align: center;\n}\n\n.reset {\n  display: block;\n}\n\n.reset-container {\n  margin: 15px;\n  display: inline-block;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(events, amplifyService, formBuilder, router, userService, loginService, authService, loadingController, modalController, loadingService, toasterService, platformService) {
        this.events = events;
...
var MenuComponent = /** @class */ (function () {
    function MenuComponent(menuService, router, navController, menuController, amplifyService, authService, platformService) {
    ...
    MenuComponent.prototype.openMenu = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menuController.open("start")
    ...
    MenuComponent.prototype.openProfileMenu = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.menuController.enable(true, "profile")
                            .then(function (res) { return console.log(res); });
                        return [4 /*yield*/, this.menuController.open("profile")];
                    case 1:
                        _a.sent();
                        this.menuController.isOpen("option")
                            .then(function (res) { return console.log("option menu is open: " + res); });
    ...
    MenuComponent.prototype.openOptionMenu = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.menuController.enable(true, 'option');
                        return [4 /*yield*/, this.menuController.open('option')];
                    case 1:
                        _a.sent();
                        this.menuController.isOpen("profile")
                            .then(function (res) { return console.log("profile menu is open: " + res); });
...
var ApptModalComponent = /** @class */ (function () {
    function ApptModalComponent(modalController, actionSheetController, toastController, userService, apptService, toasterService, platformService) {
        this.modalController = modalController;
...
var CalendarModalComponent = /** @class */ (function () {
    function CalendarModalComponent(formBuilder, apptService, userService, modalController, toasterService, platformService) {
        this.formBuilder = formBuilder;
        this.apptService = apptService;
        this.userService = userService;
        this.modalController = modalController;
...
module.exports = ".text-container {\n  text-align: center;\n}\n\n.text {\n  padding: 10px;\n}\n\n.button-container {\n  margin-top: 30px;\n  text-align: center;\n  display: -webkit-box;\n  display: flex;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ConfirmationModalComponent = /** @class */ (function () {
    function ConfirmationModalComponent(formBuilder, modalController, toasterService, router, platformService) {
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.toasterService = toasterService;
        this.router = router;
...
module.exports = "p {\n  margin: 10px;\n}\n\nimg {\n  height: 300px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var OutreachComponent = /** @class */ (function () {
    function OutreachComponent(pictureService, platoformService) {
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(userService, apptService, loadingController, authService, toasterService, router, platformService) {
        this.userService = userService;
        this.apptService = apptService;
        this.loadingController = loadingController;
        this.authService = authService;
    ...
    ProfileComponent.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, _a, role, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.registerUser = function () {
        ...
        this.userService.addUser(user)
            ...
            _this.handleError(err, err.message);
        });
    };
    ...
    RegisterComponent.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, _a, role, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
...
var SchoolComponent = /** @class */ (function () {
    function SchoolComponent(platformService) {
        this.platformService = platformService;
        this.mode = "";
    }
...
var TeamComponent = /** @class */ (function () {
    function TeamComponent(navController, platformService) {
        this.navController = navController;
        this.platformService = platformService;
        this.mode = "";
    }
...
var AppointmentService = /** @class */ (function () {
    ...
    AppointmentService.prototype.getAdolescentGroupSelfPay = function () {
        var url = "https://e1nqo2h2la.execute-api.us-east-1.amazonaws.com/default/getAdolescentSchedule";
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content-Type': 'application/json',
                "Authorization": this.authService.getToken()
    ...
    AppointmentService.prototype.bookAppointment = function (appt) {
        var url = "https://1wm21omqnc.execute-api.us-east-1.amazonaws.com/default/bookAppointment";
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content-Type': 'application/json',
                "Authorization": this.authService.getToken()
    ...
    AppointmentService.prototype.getMyAppointments = function (email) {
        var url = "https://5for6fp862.execute-api.us-east-1.amazonaws.com/default/getMyAppointments?email=" + email;
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content-Type': 'application/json',
                "Authorization": this.authService.getToken()
    ...
    AppointmentService.prototype.getAppointmentsByCounselor = function (name) {
        var url = " https://6559d4fmz9.execute-api.us-east-1.amazonaws.com/default/getAppointmentsByCounselor?counselor=" + name;
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content-Type': 'application/json',
                "Authorization": this.authService.getToken()
    ...
    AppointmentService.prototype.removeAppointment = function (appt) {
        this.schedule = this.schedule.filter(function (x) { return x.date !== appt.date; });
    };
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.login = function (username, password) {
        var url = "https://ae4o7a3u62.execute-api.us-east-1.amazonaws.com/default/login";
        var httpOptions = {
...
var PlatformService = /** @class */ (function () {
    ...
    PlatformService.prototype.getDeviceWidth = function () {
        return this.platform.width();
    };
    PlatformService.prototype.getDeviceHeight = function () {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.addUser = function (user) {
        var url = "https://a62hdz3sfj.execute-api.us-east-1.amazonaws.com/default/addUser";
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/json',
            })
